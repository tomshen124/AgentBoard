              ...
              >
                ...
                {commandsLoading ? (
                  ...
                  <div className="px-2 py-4 text-center text-xs text-muted-foreground">
                    ...
                    <p className="mt-1 text-[10px] opacity-70">~/.agentboard/commands/</p>
                  </div>
                ) : (
              ...
              >
                ...
                {loading ? (
                  ...
                  <div className="px-2 py-4 text-center text-xs text-muted-foreground">
                    ...
                    <p className="mt-1 text-[10px] opacity-70">~/.agentboard/skills/</p>
                  </div>
                ) : (
                  skills.map((skill) => (
                    <DropdownMenuItem
        ...
        <DropdownMenuGroup>
          <DropdownMenuSub>
            <DropdownMenuSubTrigger>
              ...
              <span>{t('skills.mcpLabel', 'Connectors')}</span>
            ...
            <DropdownMenuPortal>
              ...
              >
                <DropdownMenuLabel>
                  {t('skills.availableMcps', 'Connected Connectors')}
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
